...
#ocsvm
def ocsvm(train_X,train_Y,test_X,test_Y):
 print('OCSVM')
 oneclass = svm.OneClassSVM(kernel='rbf', gamma=0.000001, nu=0.05)
 oneclass.fit(train_X)
 test_pred_Y = oneclass.predict(test_X)
 test_Y[test_Y == 1] =-1
 test_Y[test_Y == 0] = 1
...
# KDD training data 125974
 ...
 train_X = train_X[y == 0] 
  #OCSVM
 print('OCSVM - start')
 ocsvm(train_X,train_Y,test_X,test_Y)
